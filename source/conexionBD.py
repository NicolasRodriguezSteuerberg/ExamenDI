...
class ConexionBD:
    ...
    def engadeRexistro(self, insertSQL, *parametros):
        ...
        :param insertSQL: Código de la consulta (insert) que se va a ejecutar
        :param parametros: Parámetros para introducir en la consulta
        """
        try:
            if self.conexion is None:
    ...
    def actualizaRexistro(self, updateSQL, *parametros):
        ...
        :param updateSQL: Consulta SQL (update) que se va a ejecutar
        :param parametros: lista de parámetros para introducir en la consulta
        """
        try:
            if self.conexion is None:
    ...
    def borraRexistro (self, borraSQL, *parametros):
        ...
        :param borraSQL: Consulta SQL (delete) que se va a ejecutar
        :param parametros: Lista de parámetros para introducir en la consulta
        """
        try:
            if self.conexion is None:
